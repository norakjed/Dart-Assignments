...
class _NewItemState extends State<NewItem> {
  ...
  void onAdd() {
    ...
    final grocery = Grocery(id: name + quantity.toString(),name: name, quantity: quantity, category: _selectedCategory);
              ...
              children: [
                ...
                Expanded(
                  child: DropdownButtonFormField<GroceryCategory>(
                    ...
                    items: GroceryCategory.values.map((type) {
                    return DropdownMenuItem(
                      value: type,
                      child: Row(
                        children: [
                          Container(width: 15, height: 15, color: type.color,),
                          SizedBox(width: 10,),
                          Text(type.name)
                        ],
                      ),
